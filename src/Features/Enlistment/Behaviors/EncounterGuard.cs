...
namespace Enlisted.Features.Enlistment.Behaviors
{
    ...
    internal static class EncounterGuard
    {
        ...
        [SuppressMessage("ReSharper", "UnusedMember.Local", Justification = "May be used for future functionality")]
        ...
        /// </summary>
        [SuppressMessage("ReSharper", "UnusedMember.Global", Justification = "May be called from other modules")]
                ...
                if (hasEncounter)
                {
                    ...
                    NextFrameDispatcher.RunNextFrame(() =>
                    {
                        ...
                        ModLogger.Debug("EncounterGuard",
                            $"Deferred encounter finish: stillHasEncounter={stillHasEncounter}");

                        if (stillHasEncounter)
                        {
                            PlayerEncounter.LeaveEncounter = true;
                            PlayerEncounter
                                .Finish(); // Default parameter forcePlayerOutFromSettlement=true is sufficient
        ...
        public static void TryAttachOrEscort(Hero lord)
        {
            ...
            var attachmentName = main.AttachedTo?.LeaderHero?.Name?.ToString() ??
                                 main.AttachedTo?.Name?.ToString() ?? "none";
            ...
            {
                ModLogger.Debug("Following",
                    $"AttachOrEscort check -> target={targetName}, distance={distance:F2}, attachedTo={attachmentName}, mapEvent={main.Party.MapEvent != null}");
            }
