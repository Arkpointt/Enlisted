...
namespace Enlisted.Features.Assignments.Behaviors
{
    ...
    public sealed class EnlistedDutiesBehavior : CampaignBehaviorBase
    {
        ...
        /// <summary>
        ///     Assigning officer roles through public APIs (as per Option A in the design) is a straightforward and dependable
        ///     method, though the player will be presented as an "official" officer.
        /// </summary>
