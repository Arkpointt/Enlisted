...
namespace Enlisted.Features.Equipment.UI
{
    ...
    public class QuartermasterEquipmentSelectorBehavior : CampaignBehaviorBase
    {
        ...
        /// </summary>
        public static void ShowEquipmentSelector(List<EquipmentVariantOption> availableVariants,
            EquipmentIndex targetSlot, string equipmentType)
        {
            try
            {
                ...
                {
                    ModLogger.Info("QuartermasterUI",
                        "No equipment variants available for grid UI - using conversation fallback");
                ...
                ModLogger.Info("QuartermasterUI",
                    $"Grid UI opened successfully with {availableVariants.Count} variants for {equipmentType}");
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        private static void ShowConversationFallback(List<EquipmentVariantOption> availableVariants,
