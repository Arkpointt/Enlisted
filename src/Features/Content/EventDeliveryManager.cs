...
namespace Enlisted.Features.Content
{
    ...
    public class EventDeliveryManager : CampaignBehaviorBase
    {
        ...
        /// </summary>
        private static void ApplyRandomBaggageLoss(int count)
        {
            var enlistment = EnlistmentBehavior.Instance;
            if (enlistment == null)
            {
        ...
        /// </summary>
        private static void ApplyBagCheckChoice(string choice)
        {
            var enlistment = EnlistmentBehavior.Instance;
            if (enlistment == null)
            {
        ...
        /// </summary>
        private static void ApplyEnlistmentAbort()
        {
            var enlistment = EnlistmentBehavior.Instance;
        ...
        /// </summary>
        private static void ApplyFatigueChange(int delta)
        {
            var enlistment = EnlistmentBehavior.Instance;
            if (enlistment == null)
            {
        ...
        /// </summary>
        private static void ApplyPromotesEffect(int targetTier)
        {
            var enlistment = EnlistmentBehavior.Instance;
            if (enlistment == null || !enlistment.IsEnlisted)
            {
        ...
        /// </summary>
        private static void ApplyFlagChanges(EventOption option)
        {
