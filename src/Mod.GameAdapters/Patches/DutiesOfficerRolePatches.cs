    ...
    public class DutiesEffectiveEngineerPatch
    {
        ...
        public static bool Prefix(MobileParty __instance, ref Hero __result)
        {
            try
            {
                ...
                ModLogger.LogOnce("duty_engineer_active", "Duties",
                    "Player assigned as effective Engineer - Engineering skill affects party");
    ...
    public class DutiesEffectiveScoutPatch
    {
        ...
        public static bool Prefix(MobileParty __instance, ref Hero __result)
        {
            try
            {
                ...
                __result = CampaignSafetyGuard.SafeMainHero;
                ModLogger.LogOnce("duty_scout_active", "Duties",
                    "Player assigned as effective Scout - Scouting skill affects party");
    ...
    public class DutiesEffectiveQuartermasterPatch
    {
        ...
        public static bool Prefix(MobileParty __instance, ref Hero __result)
        {
            try
            {
                ...
                __result = CampaignSafetyGuard.SafeMainHero;
                ModLogger.LogOnce("duty_quartermaster_active", "Duties",
                    "Player assigned as effective Quartermaster - Steward skill affects party");
    ...
    public class DutiesEffectiveSurgeonPatch
    {
        ...
        public static bool Prefix(MobileParty __instance, ref Hero __result)
        {
            try
            {
                ...
                __result = CampaignSafetyGuard.SafeMainHero;
                ModLogger.LogOnce("duty_surgeon_active", "Duties",
                    "Player assigned as effective Surgeon - Medicine skill affects party");
