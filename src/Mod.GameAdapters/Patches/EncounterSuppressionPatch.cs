...
namespace Enlisted.Mod.GameAdapters.Patches
{
    ...
    public class EncounterSuppressionPatch
    {
        ...
        {
            // Currently allowing all encounters for testing
            // This can be re-enabled later if encounter suppression is needed
            ModLogger.Debug("EncounterSuppression", "Encounter suppression disabled - allowing all encounters");
            return true;
