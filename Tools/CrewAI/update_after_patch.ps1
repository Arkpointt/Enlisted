...
# Step 1: Check decompile folder exists
...
if (-not (Test-Path $decompilePath)) {
    ...
    Write-Host "        Decompile the new Bannerlord version first!" -ForegroundColor Yellow
    exit 1
}

Write-Host "[1/3] Decompile folder found" -ForegroundColor Green
