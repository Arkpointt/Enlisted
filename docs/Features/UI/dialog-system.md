...
Centralized conversation manager that handles all military service dialogs. Prevents dialog conflicts, simplifies maintenance, and provides consistent conversation experience across all lords.
