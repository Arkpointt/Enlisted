...
All UI system documentation has been consolidated into a single comprehensive reference:

**→ [UI Systems Master Reference](ui-systems-master.md)**
...
- Removed individual system files (camp-tent.md, dialog-system.md, event-ui.md, menu-interface.md, news-dispatches.md, quartermaster.md)
