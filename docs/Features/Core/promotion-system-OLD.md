...
This document references the old reputation system (Soldier/Officer reputation, Discipline 0-10 scale). As of 2026-01-14, the system now uses:
...
Promotion requirements have been updated in code. This document needs comprehensive rewrite. See `EscalationState.cs` and `PromotionBehavior.cs` for current implementation.
