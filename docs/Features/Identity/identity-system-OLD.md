...
**Status:** ⚠️ NEEDS UPDATE - References outdated reputation system  
**Last Updated:** 2026-01-14 (Reputation system changed - Soldier/Officer rep removed)  
**Related Docs:** [Content System](../Content/content-system-architecture.md), [Event System Schemas](../Content/event-system-schemas.md)

**⚠️ DOCUMENTATION OUTDATED (2026-01-14):**
This document references the old reputation system (Soldier/Officer reputation, Discipline 0-10 scale). As of 2026-01-14:
- **Scrutiny** (0-100 scale) - Single trouble/suspicion track (replaces Discipline 0-10)
- **Native lord reputation** via `Hero.GetRelation()` - Replaces custom Officer/Soldier reputation systems

All code sections showing `SoldierReputation`, `OfficerReputation`, and `Discipline` fields are outdated. This document needs comprehensive rewrite. See `EscalationState.cs` for current implementation.
